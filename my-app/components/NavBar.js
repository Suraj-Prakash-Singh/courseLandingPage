    ...
    return (
        <div className="w-full h-max flex bg-[#0129514D] border-none items-center justify-between fixed top-0">
            <div className="w-8/12">
                <ul className="flex ml-[21rem] p-5 font-bold gap-3">
            ...
            <div className="w-2/6 flex items-center justify-evenly text-white font-medium">
                <button className="bg-inherit rounded-[20px] px-10 py-2 border ml-20 shadow-md hover:bg-slate-400">SIGN IN</button>
                <button className="bg-[#FF6905] rounded-[20px] px-6 py-2 shadow-md hover:bg-orange-400">Contact US</button>
            </div>
            <div>
